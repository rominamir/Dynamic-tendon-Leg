...
from Basde_Code import  LogLegEnv   #as DynamicLegEnv
...
def evaluate_model(seed_value):
    ...
    env = LogLegEnv(render_mode="rgb_array")  # Use 'rgb_array' for video recording
    env = RecordVideo(
        env,
...
def train_env(seed_value, train=True, fps=30):
    if train:
        ...
        env = LogLegEnv(render_mode=None)
        env.seed(seed_value)
...
if __name__ == '__main__':   
    ...
    print("this is an Logarithmic functin run")

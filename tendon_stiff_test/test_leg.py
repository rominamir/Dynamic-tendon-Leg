...
<mujoco model="2-link 6-muscle arm">
    <!--  Copyright © 2018, Roboti LLC
          ...
          This file is licensed under the MuJoCo Resource License.
    ...
    <default>
        ...
        <!-- default muscle  -->
        <!-- <muscle ctrllimited="true" ctrlrange="0 1" force="6000" gear="1"/> -->
        # <muscle ctrllimited="true" ctrlrange="0 1" force="200" forcerange="-500 0" gear="10"/>
        # <!-- <motor gear="-200" ctrlrange="0 1" forcerange="0 500"/> -->
    ...
    <tendon>
        <spatial name="T_M0" width="0.01" rgba="0.55 0.78 0.55 1"> <!-- springlength = "2.0486" --> 
            <site site="S_M0"/>
        ...
        <spatial name="T_M1" width="0.01" rgba="0.95 0.50 0.47 1" > <!--springlength="1.2341"--> 
            <site site="S_M1"/>
            <geom geom="Hip" sidesite="S_J0_1"/>
            <site site="S_L0_1"/>
        </spatial>

         <spatial name="T_M2" width="0.01" rgba="0.45 0.49 0.83 1" > <!-- springlength="1.7341" --> 
            <site site="S_M2"/>
            <geom geom="Hip" sidesite="S_J0_0"/>
            <site site="S_L0_2"/>
 ...
 <actuator>  
       <motor name="T_M0_motor" tendon="T_M0" gear="200" ctrlrange="0 1" forcerange="0 300" />
        <motor name="T_M1_motor" tendon="T_M1" gear="200" ctrlrange="0 1" forcerange="0 300" />
        <motor name="T_M2_motor" tendon="T_M2" gear="200" ctrlrange="0 1" forcerange="0 300" />  
...
model = mujoco.MjModel.from_xml_string(mujoco_model)
# Create data and launch viewer
...
# Ensure all positions are at default/reference pose
...
for i in range(model.ntendon):
    print(f"Tendon {model.names[model.name_tendonadr[i]]}: Length = {data.ten_length[i]} m")
